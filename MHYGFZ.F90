...
!       =============================================================
!       Purpose: This program computes hypergeometric function for a
!                complex argument, F(a,b,c,z), using subroutine HYGFZ
!       Input :  a --- Parameter
!                b --- Parameter
!                c --- Parameter,  c <> 0,-1,-2,...
...
DO
  ...
  WRITE(*,5000) a, b, c, x, y, zhf
END DO
STOP

5000 FORMAT (' ', 5F7.1, '  ', 2g16.8)
END PROGRAM mhygfz
