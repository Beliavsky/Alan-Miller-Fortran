...
! The line z1 = z1 has been removed!
...
REAL (dp), PARAMETER  :: pi = 3.141592653589793D0, rp2 = .63661977236758D0
COMPLEX (dp)  :: ca, ca0, cb, cck, cec, cf, cf1, cf2, cfac0, ci,  &
                 cju0, cjv0, cjvn, cpz, cqz, cr, cr0, crp, crq,  &
                 cs, cs0, csk, cyv0, cyy, z1, z2, zk
REAL (dp)     :: a0, ga, gb, pv0, v0, vg, vv, w0
INTEGER       :: k, k0, m, n
