...
REAL (r10)   :: det, scale_factor = 14549535.0_r10
...
DO i = 1, nrows
  DO j = 1, i
    a(ipos) = quad(scale_factor/(i+j-1), 0._r10)
    ipos = ipos + 1
  END DO
END DO
...
DO i = 1, nrows
  ...
  DO j = 1, i
    ...
    IF (j < i) THEN
      ...
      ipos = ipos + 1
    ELSE
      a(ipos) = quad(1._r10, 0._r10) / a(ipos)
      ipos = ipos + 1
    END IF
    kjstart = kjstart + j + 1
  END DO
...
ipos = 1
exact_start = quad(100._r10, 0._r10)
DO i = 1, nrows
  exact = exact_start
  DO j = 1, i
