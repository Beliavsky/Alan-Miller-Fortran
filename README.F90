...
The Fortran 90 version of these functions is by Alan Miller.
e-mail: amiller @ bigpond.net.au
web:    http://users.bigpond.net.au/amiller
...
simple main program for each program so that you can readily test them.
...
derivatives, including Chebyshev, Laguerre, and Hermite polynomials.
...
JY01A   Evaluate the zeroth- and first-order Bessel functions of the first
and second kinds with real arguments using series and asymptotic expansions.

JY01B   Evaluate the zeroth- and first-order Bessel functions of the first
and second kinds with real arguments using polynomial approximations.

JYNA    Evaluate a sequence of Bessel functions of the first and second kinds
and their derivatives with integer orders and real arguments (method 1).

JYNB    Evaluate a sequence of Bessel functions of the first and second jinds
and their derivatives with integer orders and real arguments (method 2).

CJY01   Evaluate the zeroth- and first-order Bessel functions of the first
and second kinds and their derivatives with complex arguments.

CJYNA   Evaluate a sequence of Bessel functions of the first and second kinds
and their derivatives with integer orders and complex arguments (method 1).

CJYNB   Evaluate a sequence of Bessel functions of the first and second kinds
and their derivatives with integer orders and complex arguments (method 2).

JYV     Evaluate a sequence of Bessel functions of the first and second kinds
and their derivatives with arbitrary real orders and real arguments.

CJYVA   Evaluate a sequence of Bessel functions of the first and second kinds
and their derivatives with arbitrary real orders and complex arguments (method 1).

CJYVB   Evaluate a sequence of Bessel functions of the first and second kinds
and their derivatives with arbitrary real orders and complex arguments (method 2).

CJK     Evaluate the coefficients for the asymptotic expansion of 
Bessel functions for large orders.

CJYLV   Evaluate Bessel functions of the first and second kinds and their
derivatives with a large arbitrary real order and complex arguments.
...
IKNA    Evaluate a sequence of modified Bessel functions of the first and second
kinds and their derivatives with integer orders and real arguments (method 1).

IKNB    Evaluate a sequence of modified Bessel functions of the first and second
kinds and their derivatives with integer orders and real arguments (method 2).

CIK01   Evaluate the zeroth- and first-order modified Bessel functions of
the first and second kinds and their derivatives with complex arguments.

CIKNA   Evaluate a sequence of modified Bessel functions of the first and second
kinds and their derivatives with integer orders and complex arguments (method 1).

CIKNB   Evaluate a sequence of modified Bessel functions of the first and second
kinds and their derivatives with integer orders and complex arguments (method 2).

IKV     Evaluate a sequence of modified Bessel functions of the first and
second kinds and their derivatives with arbitrary real orders and real arguments.

CIKVA   Evaluate a sequence of modified Bessel functions of the first and second
kinds and their derivatives with arbitrary real orders and complex arguments.

CIKVB   Evaluate a sequence of modified Bessel functions of the first and second
kinds and their derivatives with arbitrary real orders and complex arguments.

CIKLV   Evaluate modified Bessel functions of the first and second kinds and
their derivatives with a large arbitrary real order and complex arguments.

CH12N   Evaluate a sequence of Hankel functions of the first and second kinds
and their derivatives with integer orders and complex arguments.
...
first kind and their derivatives with integer orders and  real arguments.

SPHY    Evaluate a sequence of spherical Bessel functions of the 
second kind and their derivatives with integer orders and  real arguments.

CSPHJY  Evaluate a sequence of spherical Bessel functions of the first and
second kinds and their derivatives with integer orders and complex arguments.
...
of the first kind and their derivatives with integer orders and real arguments.

SPHK    Evaluate a sequence of modified spherical Bessel functions 
of the second kind and their derivatives with integer orders and real arguments.

CSPHIK  Evaluate a sequence of modified spherical Bessel functions of the first
and second kinds and their derivatives with integer orders and complex arguments.
...
KLVNZO  Evaluate the zeros of the Kelvin functions and their  derivatives.
...
STVLV   Evaluate the modified Struve function with an arbitrary order.

ITSL0   Evaluate the integral of modified Struve function L0(t) from 0 to x.
...
PBWA    Evaluate parabolic cylinder functions W(a,+/-x) and their derivatives.
...
LPMNS   Evaluate a sequence of the associated Legendre functions of the first
kind and their derivatives with real arguments for a given order.

LQMNS   Evaluate a sequence of the associated Legendre functions of the second
kind and their derivatives with real arguments for a given order.
...
COMELP  Evaluate the complete elliptic integrals of the first and second kinds.

ELIT    Evaluate the incomplete elliptic integrals of the first and second kinds.
